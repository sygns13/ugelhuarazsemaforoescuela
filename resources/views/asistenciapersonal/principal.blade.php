<div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Registro de Asistencia de Personal</h3>
                  ...
                  <template v-if="personal.activoDia==0">
                   ...
                   <template v-if="personal.activoDia==1"> 
                    ...
                    <td style="font-size: 12px; padding: 5px;">@{{ personal.turno }}</td>
                      ...
                      <template v-if="keyturno.length==0 || String(keyturno)!=String(personal.idturno)">

                      <template v-if="String(personal.idAsist)=='null' || String(personal.asistencia)=='0'">
                        <td style="font-size: 12px; padding: 5px; background: red;">
                        <b>No Asistió</b>
                         </td>
                      </template>

                      <template v-if="String(personal.asistencia)=='1'">
