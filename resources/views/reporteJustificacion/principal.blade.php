              ...
              <table class="table table-hover table-bordered" >
                ...
                <tr v-for="reporte, key in report">
                  ...
                  <td style="font-size: 10px; padding: 3px;">
                    ...
                    <a  v-if="reporte.namefile.length>0" v-bind:href="'{{ asset('/img/informacion/files/')}}/'+reporte.rutafile" v-bind:download="reporte.namefile">@{{ reporte.namefile }}</a>


                      <a  v-if="reporte.namefile.length==0" v-bind:href="'{{ asset('/img/informacion/files/')}}/'+reporte.rutafile" v-bind:download="reporte.namefile">@{{ licencia.namefile }}</a>
                      
                    </template>

                    
                    {{--    <a href="#" v-if="licencia.rutafile.length>0" class="btn bg-purple btn-sm" v-on:click.prevent="verArcivo(licencia)" data-placement="top" data-toggle="tooltip" title="Ver Archivo Adjunto"><i class="fa fa-list-alt"></i></a>--}}
                  </td>
