<script type="text/javascript">
    ...
    data:{
        ...
        cabehoy:'Registros que cubren la fecha: {{$fecha}}',
        cabemes:'Registros que cubren días del mes de {{nombremes($mesActual)}} de {{$yearActual}}',
        cabeyear:'Registros del año {{$yearActual}}',
