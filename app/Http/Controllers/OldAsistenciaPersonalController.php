...
class OldAsistenciaPersonalController extends Controller
{
    /**
    ...
    public function index1()
    {
        ...
        $secActual=date("s");
           ...
           $turnoActivo=Turno::where('activo','1')->where('borrado','0')->where('tipo','1')->where('horaIni','<=',$hora)->where('horaFin','>=',$hora)->limit(1)->get();
            ...
            return view('oldasistenciapersonal.index',compact('modulo','imagenPerfil','tipouser','fecha','hora','turnoActivo','diaActual','mesActual','yearActual','horaActual','minActual','secActual','fecnow'));
